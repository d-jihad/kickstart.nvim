...
-- Move between tabs (buffers) with Shift + h/l
...
-- Close current tab without closing the split window
vim.keymap.set('n', '<leader>x', function()
  local bd = require 'bufdelete'
  bd.bufdelete(0, false)
end, { desc = '[X] Close Current Tab' })
...
require('lazy').setup({
  ...
  },
  {
    ...
    opts = {
      ...
      size = 20,
      open_mapping = [[<c-\>]], -- Shortcut to open/close (Control + Backslash)
      hide_numbers = true,
  ...
  },
  {
    ...
    branch = 'regexp', -- This branch is recommended for better performance
    dependencies = {
    ...
    keys = {
      ...
      { '<leader>vs', '<cmd>VenvSelect<cr>', desc = 'Select [V]irtual [E]nv' },
    },
  },
  ...
  { 'famiu/bufdelete.nvim' },
  {
    ...
    opts = {
      options = {
        mode = 'buffers', -- This makes it show open files as tabs
        offsets = {
          {
            filetype = 'neo-tree',
            text = 'File Explorer',
